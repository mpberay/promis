    ...
    <div class="container-fluid p-0"> 
      <div class="row m-0">
        <div class="col-xl-7 p-0">
          <img class="bg-img-cover bg-center" src="<?php echo base_url(); ?>/vendors/cuba/assets/images/page-error/page_404.jpg" alt="looginpage">
        </div>
            ...
            <div>
              <div class="login-main"> 
                ...
                <div class="text-end mt-3">
                  <a class="btn btn-pill btn-outline-secondary btn-lg" type="button"  href="<?= route_to('homePage')?>" data-bs-original-title="btn btn-pill btn-outline-secondary btn-lg" data-original-title="btn btn-pill btn-outline-secondary btn-lg">
                    <span class="fa fa-arrow-left"></span> Go To Homepage
                  </a>
                </div>
              </div>
            </div>
