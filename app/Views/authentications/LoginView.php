...
<html lang="en">
  ...
  <body >
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-xl-5"><img class="bg-img-cover bg-center" src="<?= base_url(); ?>/vendors/cuba/assets/images/login/3.jpg" alt="looginpage"></div>
              ...
              <form class="theme-form" method="POST" action="javascript:void(0)" id="FrmLogin">
                ...
                <div class="form-group">
                  ...
                  <div class="form-input position-relative">
                    ...
                    <div class="show-hide">
                      <span class="show" onclick="ShowPassword();" id="SpanPassword"></span>
                    </div>
